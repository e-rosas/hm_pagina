          ...
          <div class="card bg-default shadow border-0">
            ...
            <blockquote class="card-blockquote">
              ...
              <h4 class="display-3 font-weight-bold text-white">
                Aceptamos seguros de E.U. con plan PPO.
              </h4>
              <p class="lead text-italic text-white">
                <a href="#contact">
                  Contáctenos para saber si su plan tiene cobertura en Hospital
                  México
                </a>
              </p>
            </blockquote>
      ...
      <div class="row">
        <div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
          <div class="px-4">
            ...
            <div class="pt-4 text-center">
              <h5 class="title">
                <span class="d-block mb-1">Aetna</span>
              </h5>
            </div>
          </div>
        </div>
        <div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
          <div class="px-4">
            ...
            <div class="pt-4 text-center">
              <h5 class="title">
                <span class="d-block mb-1">BlueCross BlueShield</span>
              </h5>
            </div>
          </div>
        </div>
        <div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
          <div class="px-4">
            ...
            <div class="pt-4 text-center">
              <h5 class="title">
                <span class="d-block mb-1">R.F.K. Medical Plan</span>
              </h5>
            </div>
          </div>
        </div>
        <div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
          <div class="px-4">
            ...
            <div class="pt-4 text-center">
              <h5 class="title">
                <span class="d-block mb-1">Transwestern</span>
              </h5>
            </div>
          </div>
        </div>
